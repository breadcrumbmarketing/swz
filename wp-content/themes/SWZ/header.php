...
<!-- Header Top -->
<div class="swz-header-top">
    <div class="swz-header-container">
        <div class="swz-header-top-content">
            <div class="swz-contact-info">
  ...
  <div class="phone-container">
       ...
       <!--  <div class="toolkit">
            <div class="contact-info">
                ...
                <p><strong>hamy@breadcrumb.com</strong> Support Email</p>
            </div>
            <div class="qr-code">
                ...
                <span>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/icons/contact/email-9-svgrepo-com.svg" alt="Email">
                    info@swz.de
                </span>
                <span>
...
<!-- Main Header -->
<header class="swz-header-main">
    <div class="swz-header-container">
        <div class="swz-main-nav">
            <!-- Logo -->
            <a href="<?php echo home_url('/'); ?>" class="swz-logo">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/logo/SWZ-logo-white.webp" alt="<?php bloginfo('name'); ?>">
            </a>
            
            <!-- Desktop Navigation -->
            <nav class="swz-nav-links">
                <?php
                wp_nav_menu(array(
                    'theme_location' => 'primary-menu',
                    'container' => false,
                    'menu_class' => 'swz-menu-items',
                    'fallback_cb' => false,
                    'items_wrap' => '<ul class="swz-menu-items">%3$s</ul>'
                ));
                ?>
            </nav>
            
            <!-- Search and Login -->
            <div class="swz-search-login">
    ...
    <input type="search" 
           ...
           aria-label="Search">
                ...
                <a href="<?php echo wp_login_url(home_url()); ?>" class="swz-login-btn">

                
                <button id="FSfullscreen-btn" class="FSfullscreen-button">
      ...
      <svg width="66px" height="43px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <g id="arrow" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <path id="arrow-icon-three" d="M0.154393339,3.89485454 L3.97631488,0.139296592 C4.17083111,-0.0518420739 4.48263286,-0.0518571125 4.67716753,0.139262789 L25.6916134,20.7848311 C26.0855801,21.1718824 26.0911863,21.8050225 25.704135,22.1989893 C25.7000188,22.2031791 25.6958657,22.2073326 25.6916762,22.2114492 L4.67709797,42.8607841 C4.48259567,43.0519059 4.17082418,43.0519358 3.97628526,42.8608513 L0.154518591,39.1069479 C-0.0424848215,38.9134427 -0.0453206733,38.5968729 0.148184538,38.3998695 C0.150289256,38.3977268 0.152413239,38.395603 0.154556228,38.3934985 L16.9937789,21.8567812 C17.1908028,21.6632968 17.193672,21.3467273 17.0001876,21.1497035 C16.9980647,21.1475418 16.9959223,21.1453995 16.9937605,21.1432767 L0.15452076,4.60825197 C-0.0425130651,4.41477773 -0.0453986756,4.09820839 0.148075568,3.90117456 C0.150162624,3.89904911 0.152268631,3.89694235 0.154393339,3.89485454 Z" fill="#FFFFFF"></path>
            ...
            <!-- Mobile Menu Button -->
            <button class="swz-mobile-menu-btn" aria-label="Toggle Menu">
...
<!-- Mobile Menu -->
<div class="swz-mobile-menu">
    <button class="swz-close-menu" aria-label="Close Menu"></button>
    <div class="swz-mobile-menu-content">
        <!-- Mobile Search -->
        ...
        wp_nav_menu(array(
            'theme_location' => 'primary-menu',
            'container' => 'nav',
            'container_class' => 'swz-mobile-nav',
            'menu_class' => 'swz-mobile-menu-items',
            'fallback_cb' => false
        ));
        ?>
